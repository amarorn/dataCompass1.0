...
exports.MongoMLRepository = void 0;
...
class MongoMLRepository {
     ...
     */
    async processCSVForML(csvId, filename, from, csvData) {
        try {
            ...
            const mlRecords = csvData.map((row, index) => {
     ...
     * Criar resumo do dataset
     */
    async createDatasetSummary(csvId, filename, records, dataAnalysis) {
        try {
            const db = this.connection.getDb();
            ...
            await collection.replaceOne({ csvId }, summary, { upsert: true });
     ...
     */
    calculateNumericStatistics(records, numericFeatures) {
        const stats = {};
     ...
     */
    calculateCategoricalStatistics(records, categoricalFeatures) {
        const stats = {};
...
exports.MongoMLRepository = MongoMLRepository;
//# sourceMappingURL=MongoMLRepository.js.map