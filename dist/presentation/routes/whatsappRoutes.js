...
const MessageProcessorService_1 = require("../../application/services/MessageProcessorService");
...
async function initializeServices() {
    try {
        ...
        const userRepository = new MongoUserRepository_1.MongoUserRepository(db);
        registrationService = new WhatsAppRegistrationService_1.WhatsAppRegistrationService(userRepository);
...
router.get('/webhook', (0, errorHandler_1.asyncHandler)(async (req, res) => {
...
router.post('/template', (0, errorHandler_1.asyncHandler)(async (req, res) => {
